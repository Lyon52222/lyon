...
#See RFC 3986 : http: // www.ietf.org/rfc/rfc3986.txt
    ...
    dec_octet =
        digit | [1 - 9] digit | "1" digit{2} | 2 [0 - 4] digit | "25"[0 - 5];
    ...
    authority = ( (userinfo %save_userinfo "@")? host >markh %save_host (":"
port >markh %save_port)? ) >markh;
...
#add(any-- ascii) support chinese
    ...
    hier_part = ("//" authority path_abempty > markh % save_path) |
